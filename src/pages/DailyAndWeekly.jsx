    ...
    <div>
         ...
         <Typography>
            <p style={{fontSize:"20px"}}>
                Every weekday the team would document down what was done for that day.
                </p>
                <p style={{fontSize:"20px"}}>Each day we sent them to our clients and also to get feedback on our progress.</p>
            <p style={{fontSize:"20px"}}>
    ...
    <Timeline position="alternate">
      ...
      <TimelineItem>
        ...
        <TimelineContent>
             ...
             <Typography>
                <p>Finalised Solution + Implementation Planning!</p>
                <br></br>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
            ...
            <br></br>
                     <p style={{fontSize:"30px"}}>Week 2 Video</p>
                     <ReactPlayer
                        url={weekTwoVideoURL}
                        controls
                        width="100%"
